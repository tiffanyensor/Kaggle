...
# some other things to try (feature engineering)
# - turn sibsp and parch into catgeorical variables (e.g., >0)
# - any features that can be combined? maybe combine sibsp and parch to n_relations or fam_size
# - anything that can be extracted from ticket (first letters or just numbers, etc)
# - use the rest of the titles, but this might lead to overfitting since theres so few Rev, Dr, etc.
# - try some transformations (square, power, log)
